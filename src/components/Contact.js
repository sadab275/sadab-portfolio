        ...
        <div name='contact' className='w-full h-screen bg-gradient-to-b from-black to-gray-800 text-white'>
            ...
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
                ...
                <div className='flex justify-center items-center'>
                    <form action="https://getform.io/f/c86f2155-8b6a-48a5-85ea-27a17aef2b97" method='POST' className='flex flex-col w-full md:w-1/2'>
                        ...
                        <input type="text" name="email" id="" placeholder='Enter your email' className='my-4 p-2 bg-transparent border-2 rounded-md text-white focus:outline-none' />
